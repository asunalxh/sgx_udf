...
static sgx_status_t SGX_CDECL sgx_ecall_add(void* pms)
{
	...
	ecall_add(_in_id_data, _in_valuesPointer);
...
{
	sgx_status_t status = SGX_SUCCESS;
	size_t _len_u_arr = count * size;
	size_t _len_v_arr = count * size;
