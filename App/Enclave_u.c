...
static sgx_status_t SGX_CDECL Enclave_ocall_add(void* pms)
{
	ms_ocall_add_t* ms = SGX_CAST(ms_ocall_add_t*, pms);
	ocall_add(ms->ms_u_arr, ms->ms_v_arr, ms->ms_count, ms->ms_size);
